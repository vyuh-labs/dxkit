...
export const swift: LanguageSupport = {
  ...
  // The SwiftPM manifest carries the .swift extension but is build CONFIG,
  // not a test-gap candidate (4.2). KNOWN names only.
  toolingConfigPatterns: ['Package.swift', 'Package@swift-*.swift'],
