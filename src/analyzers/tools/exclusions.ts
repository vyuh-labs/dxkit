...
export function getPythonExcludeFilter(cwd: string): {
  ...
  // On a real repo the densest-file metric ranked a webpack-hash
  // bundle under a bundled asset directory as 4,606 "functions" — the
  // kind of metric that makes the "split your densest file"
  // recommendation read as a bug to anyone who knows what the file is.
  //
