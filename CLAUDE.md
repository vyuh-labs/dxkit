...
`src/languages/{python,typescript,go,rust,csharp,kotlin,java,ruby,swift}.ts`. Dispatch everywhere
...
- `src/languages/{python,typescript,go,rust,csharp,kotlin,java,ruby,swift}.ts` — one file per language
