...
`src/languages/{python,typescript,go,rust,csharp,kotlin,java,ruby,swift,php}.ts`. Dispatch everywhere
...
- `src/languages/{python,typescript,go,rust,csharp,kotlin,java,ruby,swift,php}.ts` — one file per language
